...
<script src="script.js"></script>                 
  ...
  <body>
    ...
    <div class="container" style="border: 2px solid red; border-radius: 50px 0px; margin-top: 10%; margin-bottom: 5%">
    <div class="box-header">
        <a onclick="addForm()" class="btn btn-success"><i class="fa fa-plus-circle"></i> Comment Izin / Informasi Ke Guru</a>
      <div class="content">
    ...
    <footer style="margin-left: 40%">
      ...
      <p>Contact information: <a href="mailto:someone@example.com">someone@example.com</a>.</p>
        ...
        $(function(){
           ...
           $('#modal-form form').validator().on('submit', function(e){
              if(!e.isDefaultPrevented()){
                 var id = $('#id').val();
                 if(save_method == "add") url = "{{ route('com.store') }}";
                 else url = "com/"+id;
        ...
        function addForm(){
           ...
           $('.modal-title').text('Buat Comment / Izin');
        }
        </script>
</html>
